...
public class AppController {
    ...
    @Operation(
        summary = "REST API to automatically load test data.",
        description = "Testing API that generates a list of preset AppDtos and adds them to the database using the createApplication API.  This is just less messy and fiddly to have as an API that can be used on demand.  And this really needs to be removed or commented out when not being used for testing.")
    @ApiResponse(
        responseCode = "201",
        description = "HTTP STATUS 201 CREATED")
    ...
    public ResponseEntity<List<AppDto>> addTestData() {
        List<AppDto> testApps = Arrays.asList(
            new AppDto("United Beverage Security Services", "Java Engineer", null, "New York, NY"),
            ...
            new AppDto("Medium Roast Threat Intelligence", "Java Developer", null, "Portland, OR"),
